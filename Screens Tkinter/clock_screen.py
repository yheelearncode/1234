...
class ClockScreen(tk.Frame):
    ...
    def __init__(self, controller):
        ...
        self.layout.pack()  # was addWidgetself.date_label)
        ...
        weather_dust_layout.pack()  # was addWidgetself.weather_label)
        ...
        weather_dust_layout.pack()  # was addWidgetself.dust_label)
        ...
        self.layout.pack()  # was addWidgetself.memo_box)

        # 알람 박스
        self.alarm_box = tk.Frame()
        ...
        alarm_layout.pack()  # was addWidgetself.alarm_regular_label)
        ...
        alarm_layout.pack()  # was addWidgetself.alarm_temp_label)

        self.layout.pack()  # was addWidgetself.alarm_box)
